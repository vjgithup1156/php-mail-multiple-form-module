                                    ...
                                    <nav>
                                        <ul id="navigation">
                                            ...
                                            <!-- <div class="sub-nav"> -->
                                                ...
                                                <ul class="submenu">
                                                    <li> <a href="#sliding-one">Seychelles</a></li>
                                                    <li> <a href="#sliding-one">Goa</a></li>
                                                    <li> <a href="#sliding">New Zealand</a></li>
                                                    <li> <a href="#sliding">USA </a></li>
                                                    <li> <a href="#sliding-one">Spain</a></li>
                                                </ul>
                                                    <!-- <ul class="submenu">
...
<div class="modal fade" id="myModal1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
       <div class="modal-content">
          ...
          <h4 class="modal-title" id="myModalLabel">Step 1/9</h4>
          ...
          <div class="modal-body">
             <form id="mail_form" class="registration-form">
                ...
                <div id="model_1"  style="display:block;">
                <fieldset style="display: block;">
                   <div class="form-bottom">
                   <h4>Pic Your Category</h4>
            <ul>
 
 <li><input type="checkbox" id="media[]" name="media[]"
 
 value="Turning my Ideas into an Action Plan">Founder Of a Company</li>
 
 <li><input type="checkbox" id="media[]" name="media[]"
 
 value="Grow personally as a leader of a team / brand">Freelancing On Projects</li>
 
 <li><input type="checkbox" id="media[]" name="media[]"
 
 value="Collaborators to change the world / create impact">Cultural/Creative Professionl
 </li>
 
 <li><input type="checkbox" id="media[]" name="media[]"
 
 value="Creative Block / Find Inspiration">Self-run Business Owners
 </li>
 
 <li><input type="checkbox" id="media[]" name="media[]"
 
 value="Mental Wellness">Working with Corporates
 </li>
 
 <li><input type="checkbox" id="media[]" name="media[]"
 
 value="Refining my Business Ideas & Plans">Family Business Entrepreneur
 </li>
 <li><input type="checkbox" id="media[]" name="media[]"
 
 value="Branding/Social Strategy for my Business">Exploring My Option
 </li>
        ...
        <!-- model - 5 -->
                ...
                <div class="form-top">
                      <div class="form-top-left">
                         <!-- <h3>Step 3 / 3</h3> -->
                         <h4>About You</h4>
                         <p>Which Univercity/Collage did you go to...</p>
                         <!-- <p></p> -->
                      </div>
                      <!-- <div class="form-top-right">
                         <i class="fa fa-twitter"></i>
                   ...
                   <div class="form-bottom">
                      <div class="form-group">
                         <label class="sr-only">Bachelors</label>
                         <input placeholder="Enter Your Univercity..." class="bachelors form-control" id="bachelors" name="bachelors" type="text">
                      </div>
                      <div class="form-group">
                         <label class="sr-only">Masters</label>
                         <input  placeholder="Enter Your Univercity..." class="masters form-control" id="masters" name="masters" type="text">
                      </div>
                      <!-- <button type="button" class="btn btn-previous">Previous</button>
                      <button type="submit" class="btn">Sign me up!</button> -->
                   </div>
                ...
                <div class="form-top">
                   ...
                   <div class="form-bottom">
                   <label class="gen">  Gender:   </label>  <br>
 ...
 <input type="radio" id="radio" name="radio" value="others"/> Others &nbsp;<br/>   
                      ...
                      <label class="gen">  Purpose:  </label>  <br>
   ...
   <!-- <label for="vehicle3"> I have a boat</label><br><br> -->
                      ...
                      <div class="form-group">
                         ...
                         <input placeholder="Enter hobbies..." class="form-repeat-password form-control" id="hobbies" name="hobbies" type="text">
                      </div>
                      <div class="form-group">
   ...
   <select id="salary" name="salary">
     ...
     <option value="4 to 5L">4 to 5L</option>
                ...
                <div id="model_8"  style="display:none;">
                <fieldset style="display: block;">
                <div class="form-top">
                      <div class="form-top-left">
                         <!-- <h3>Step 3 / 3</h3> -->
                   ...
                   <div class="form-bottom">
                      <div class="form-group">
                         ...
                         <input placeholder="Enter id..." class="form-facebook form-control" id="facebook" name="facebook" type="text">
                      </div>
                      <div class="form-group">
                         <label class="sr-only" for="form-twitter">Twitter</label>
                         <input  placeholder="Enter id..." class="form-twitter form-control" id="twitter" name="twitter" type="text">
                      </div>
                      <div class="form-group">
                         <label class="sr-only" for="form-google-plus">Instagram</label>
                         <input placeholder="Enter id..." class="form-Instagram form-control" id="insta" name="insta" type="text">
                      </div>
                      <div class="form-group">
                ...
                <div id="model_9" style="display: none;">
                ...
                <fieldset style="display: block;">
                   ...
                   <div class="form-bottom">
                      <div class="form-group">
                         ...
                         <input placeholder="Enter name..." class="form-first-name form-control input-error" id="name123" name="name123" type="text">
                      </div>
                      <div class="form-group">
                         <label class="sr-only" for="form-last-name">Phone</label>
                         <input placeholder="Enter phone..." class="form-last-name form-control input-error" id="phone123" name="phone123" type="phone">
                      </div>
                      <div class="form-group">
                         <label class="sr-only" for="form-about-yourself">Email</label>
                         <input placeholder="Enter email..." class="form-last-name form-control input-error" id="email123" name="email123" type="email">
 
                      </div>
                      <div class="form-group">
                         <label class="sr-only" for="form-about-yourself">DOB</label>
                         <input placeholder="Enter date..." class="form-last-name form-control input-error" id="dob123" name="dob123" type="date">
          ...
          <div class="modal-footer">
             ...
             <button type="button" id="send_func" style="display: none;">Send</button>
...
$('#move_next').on('click', function(){
    if($('#model_1').css('display') == 'block'){
        ...
        if($('input[name="media[]"]:checked').length < 2){
            alert('Atleast Select Two Options')
            return false;
        }else{
            var int = 1;
            var int1 = 2;
        ...
        if($('input[name="design[]"]:checked').length < 2){
            alert('Atleast Select Two Options')
            return false;
        }else{
            var int = 2;
        ...
        if($('input[name="mod[]"]:checked').length < 2){
            alert('Atleast Select Two Options')
            return false;
        }else{
            var int = 3;
       ...
       if($('input[name="data[]"]:checked').length < 2){
        alert('Atleast Select Two Options')
        return false;
       }else{
        var int = 4;
    ...
    if($('#hobbies').val() === '' || $('#city').val() === '' || $('#salary').val() === ''){
            alert('Fill the fields')
            return false;
        }else{
           var int = 7;
    ...
    if($('#model_8').css('display') == 'block'){

    if($('#facebook').val() === '' || $('#twitter').val() === '' || $('#insta').val() === '' || $('#web').val() === ''){
    alert('Fill the fields')
    return false;
    }else{
    var int = 8;
    ...
    if($('#model_9').css('display') == 'block'){

        if($('#name123').val() === '' || $('#phone123').val() === '' || $('#email123').val() === '' || $('#dob123').val() === ''){
            alert('Fill the fields')
            return false;
        }else{
            var int = 9;
    ...
    $('#myModalLabel').html('Step '+int1+'/9')
    $('#model_'+int).css('display','none')
    $('#model_'+int1).css('display','block')
    if(int1 == 9){
    $('#send_func').css('display','block')
    }
